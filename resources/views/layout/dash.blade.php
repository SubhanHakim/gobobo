...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white text-uppercase" href="#">Gobobo</a>
        ...
        <div class="row h-100">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div
                    ...
                    <h1 class="h2">Welcome back, Subhan Hakim</h1>
                </div>
            </main>
        </div>
    </div>
